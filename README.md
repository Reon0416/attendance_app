...
| No  | 機能名                       | 概要                                                                               | 対応課題           |
| --- | ---------------------------- | ---------------------------------------------------------------------------------- | ------------------ |
| 1   | **健康チェックアンケート**   | 出勤時に体調・モチベーションを 1〜10 で入力。一定値以上ならオーナーに Gmail 通知。 | 健康状態の把握     |
| 2   | **リアルタイム給与計算**     | 打刻履歴から給与を自動計算し、現時点での報酬を表示。                               | モチベーション維持 |
| 3   | **金額目標設定・達成度表示** | LV1〜3 で目標金額を設定し、達成度を数値・円グラフで表示。                          | モチベーション維持 |
